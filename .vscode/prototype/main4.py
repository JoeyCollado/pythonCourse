...
questions = [
    ...
    ("Where is philippines located?", ["Europe", "Asia", "South America", "Antartica"], "Asia"),
    ("First man to set foot on moon?", ["Niel Armstrong", "Saul man Goodwill", "Luffy", "Lebron"], "Niel Armstrong"),
...
#Score Tracking:
#Added a self.score attribute to keep track of the score.
#Created a self.score_label to display the score on the window.

#Disabling Buttons:
#Added code in the check_answer method to disable all answer buttons if an incorrect answer is given.

#Restart Button:
#Added a self.restart_button and the corresponding restart_game method to reset the score and remaining questions and generate a new question.