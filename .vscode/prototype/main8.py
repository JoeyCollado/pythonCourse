...
class QuizGenerator: #class
    ...
    def __init__(self, window): #instance and inside is called the constructor with parameters
        ...
        self.quiz_frame = tk.Frame(window, bg="black") #set the main interface color to black

        # Set the size and properties of the GUI window
        self.window.geometry("1000x800")  # Set the window width and height
        ...
        self.score = 0 #default score when you start the game

    def show_quiz(self): #function
    ...
    def new_question(self): #function
        ...
        self.feedback_label.config(text="Choices:",  fg="green", font=("System",23), pady=5)  # Reset feedback label

    def check_answer(self, i): #function
        ...
        if selected_answer == self.correct_answer:
            ...
            self.window.after(3000, self.new_question) #moves to the next question right after you pick the correct answer
    
        else:
            self.feedback_label.config(text=f"Incorrect! The correct answer is {self.correct_answer}.", fg="red", font=("System", 14))  # Display incorrect feedback
            for button in self.buttons:
    ...
    def restart_game(self): #function
